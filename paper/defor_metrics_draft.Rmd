...
However, Appendix \@ref(survival-appendix) shows that $exp(\beta_{coxDID})$ only identifies the $HRTT$ under an alternative assumption:
...
## Survival analysis {#survival-appendix}

## Cox PH DID identifies $HRTT$ when proportional trends assumption holds {#prop-tends}
