...
\item Property-level unobservables negatively impact model bias, coverage, and RMSE when the unit of analysis does not match the true scale of the deforestation process. This is shown via Monte Carlo simulations.
\item When unobservables operate at several different scales, models that match the scale of the primary driver of deforestation heterogeneity outperform the alternatives. This is shown via Monte Carlo simulations.
