...
<!-- Robert to do: Clean up prior paragraph to improve flow -->
...
<!-- Robert to do: work through the order of this section -->
...
<!-- Robert to do: Why is this section link broken? -->
...
<!-- Robert to do: need to integrate these paragraphs -->
Survival analysis is one potential alernative to traditional econometric estimators in the context of deforestation. The simple cox DID, however, is not a viable solution. Column 2 of Figure \@ref(fig:summary-fig) shows the bias associated with Regression 3. 
