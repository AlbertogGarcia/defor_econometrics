...
## FOR ALBERT:
# Figure 12: Should adjust spacing so labels don't get cut off 
# ~ Line 513: Confirm text doesn't match figure. Update
# ~ Line 537: Need to add a sentence or two with a so-what for the selection bias section.
...
<!-- IS PREVIOUS SENTENCE STILL TRUE? DOESN'T LOOK LIKE IT IN FIGURE -->
...
<!-- NEED TO ADD A SHORT SENTENCE OR TWO DESCRIBING A TAKE-AWAY FOR THIS SECTION. MAYBE JUST THESE TWO SENTENCES FROM THE COMMENTED OUT TEXT BELOW: -->
<!-- We note that in practice, researchers cannot recover the second and fourth terms of the bias term in equation 10, meaning that the magnitude of this bias is unknown to the researcher. However, this bias is likely to be of a smaller magnitude in reality than in our simulated setting, since our simulated time frame for forest regrowth is too short to reflect true reforestation timing.  -->
