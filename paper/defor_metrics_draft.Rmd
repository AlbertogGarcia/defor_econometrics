...
Other literatures have accounted for the irreversibility in the outcome of interest using survival models. For example, many papers in health economics are interested in mortality as the outcome of interest. Survival models ... 

Figure XX shows estimates from a cox proportional hazards model, where the hazard ratio of interest has been converted into the $ATT$. 

While the cox proportional hazards model recovered the appropriate parameter, there are several reasons why survival models may not be preferable in the context of estimating the impacts of conservation interventions on deforestation rates. 

We explore how some of these factors influence the relative performance of various models in the following sections. 
...
Group $a$: 
$$y_{it} = \beta_{0,a} 1\{ t = 0\} + \beta_{1,a}1\{ t = 1\} + \beta_{2,a}1\{ t = 2\} + \beta_{3,a}1\{ t = 3\}+ \beta_{4,a}1\{ t = 4\} + \tau_a 1\{ t \geq 2\} +\alpha_i + u_{it}$$

Group $b$: 
$$y_{it} = \beta_{0,b} 1\{ t = 0\} + \beta_{1,b}1\{ t = 1\} + \beta_{2,b}1\{ t = 2\} + \beta_{3,b}1\{ t = 3\}+ \beta_{4,b}1\{ t = 4\} + \tau_b 1\{ t \geq 3\} +\alpha_i + u_{it}$$
