...
<!-- ** 
Do we need to assume specific variance for alpha and mu at this point? Think it would be preferable to keep everything as general as possible, and then to assign all arbitrary parameters in one location.
-->
