...
```{r multiGT, results = FALSE, warning = FALSE, fig.cap="New estimators, similar to TWFE regressions with pixel unit fixed effects, cannot identify ATT with pixel as unit of analysis", fig.pos='H', fig.width = 7, fig.height = 7, fig.show='hold'}
