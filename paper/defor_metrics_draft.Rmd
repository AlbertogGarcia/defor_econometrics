...
<!-- Kelsey - What about starting with an example? Something to give a hook, articulate why RS data are a powerful contribution to IE in conservation, but one with pitfalls? Then get back to the general stuff —  -->
...
### Analytical proof in two-period two-group case
...
Thus, if the deforestation rate is higher in the treatment group both before and after treatment, the bias will be positive (and vice versa). 
