...
```{r summary_fig, fig.cap="bias, distribution, and coverage of all models with standard errors clustered at the level of the model fixed effects. The pixel level DID is clustered at the pixel level. ", fig.show='hold', fig.pos = 'H', out.width="100%"}
