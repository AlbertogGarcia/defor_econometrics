...
, where $t_0$ is the year that the intervention is implemented; $D_i$ is a dummy equal to one if pixel $i$ is ever treated; and $\gamma_t$ and $\lambda_i$ are year and pixel fixed effects, respectively. 
...
kable(coverage_did[,2:7], format = "latex", row.names = FALSE, 
...
kable(coverage_uoa, format = "latex", row.names = FALSE, 
      caption = "Table of coverage in presence of property level unobservables", 
      col.names = NULL) %>% 
  add_header_above(c("unit of analysis"=1,"fixed effects"=1, "standard error structure"=1, "coverage probability" = 4), escape = FALSE, line =TRUE, bold = TRUE)%>%
  add_header_above(c(" "=1, " "=1, " "=1, "$\\sigma_p = 0$"=1, "$0.05$" = 1, "$0.15$" = 1, "$0.25$" = 1), escape = FALSE, line =FALSE, bold =FALSE)%>%
  kable_styling(font_size = 10, latex_options = c("HOLD_position"),bootstrap_options = c("striped", "hover", "condensed", "responsive"),#full_width = TRUE
                position = "center")
...
kable(coverage_fe, format = "latex", row.names = FALSE, 
      caption = "Table of coverage in presence of property level unobservables", 
      col.names = NULL) %>% 
  add_header_above(c("unit of analysis"=1,"fixed effects"=1, "standard error structure"=1, "coverage probability" = 4), escape = FALSE, line =TRUE, bold = TRUE)%>%
  add_header_above(c(" "=1, " "=1, " "=1, "$\\sigma_p = 0$"=1, "$0.05$" = 1, "$0.15$" = 1, "$0.25$" = 1), escape = FALSE, line =FALSE, bold =FALSE)%>%
