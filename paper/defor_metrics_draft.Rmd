...
```{r, echo=FALSE,out.width="49%", fig.cap="Left: deforestation observed in the first vs. second period in treated and untreated units", fig.show='hold', fig.align='center'}
