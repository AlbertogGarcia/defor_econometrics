...
lapply(1:length(RMSE), function(i) {
  ...
  text(x= i, y=midline+0.005, paste0(RMSE[i]), col="black", font=1, cex=.8)
...
legend(x=6.5, y=0.045, col = "grey50", legend = "0.05 to 0.95 quantile \n of estimate distribution", seg.len=0.65, inset = 0.005,  box.lty=0, cex=1.2, lty = 1, lwd = 4, bg="transparent")
...
lapply(1:length(RMSE), function(i) {
  # text(x= i, y=min(ylim)+.002, paste0(i), col="black", font=2, cex = 1)
  #mtext(paste0(i), side=1, at = i, font=2, cex=.95)#, line=1, at=-1)
  text(x= i, y=topline-0.0065, paste0(RMSE[i]), col="black", font=1, cex=.85)
...
text(x=3
     , y=.017, expression(paste(sigma[p],"=0.0")), col="black", font=2, cex = 1.5)
text(x=13
     , y=.017, expression(paste(sigma[p],"=0.1")), col="black", font=2, cex = 1.5)
text(x=23
     , y=.017, expression(paste(sigma[p],"=0.25")), col="black", font=2, cex = 1.5)
text(x=33
     , y=.017, expression(paste(sigma[p],"=0.5")), col="black", font=2, cex = 1.5)
