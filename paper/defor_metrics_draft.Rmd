...
## FOR ALBERT:
# - Edit appendix referenced in section 2.3
...
Both in conservation and alternative settings, researchers using Regression 3 make Assumption 1, and evaluate whether it is plausible in their setting. However, Appendix \@ref(survival-appendix) shows that $exp(\beta_{coxDID})$ only identifies the $HRTT$ under an alternative assumption:
...
```{r multiGT2, fig.cap="TWFE regressions suffer from weighting concerns when treatment effects vary across groups and through time", results = FALSE, warning = FALSE, out.width="100%", fig.pos='H', fig.width = 10, fig.height = 6, fig.show='hold'}
