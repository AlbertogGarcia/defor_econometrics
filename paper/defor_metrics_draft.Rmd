...
<!-- Although we do not explore grid cell or property size/weighting at this point, it woulld be good to give some frame of reference. I'm thinking we pretend each pixel is 30x30 and then determine how many pixels each property/grid/etc. are made of -->
