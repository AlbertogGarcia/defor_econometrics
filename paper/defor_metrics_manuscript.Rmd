...
This shows that the implicit parallel trends assumption made when using $y^{alt}_{it}$ as an outcome is equivalent to assuming that the probability of clearing post-treatment for the control units is equivalent to what it would have been for the treatment units had they not received treatment.
...
<!-- Under the parallel trends assumption and substituting for the unobserved term, $P(y_{i2}(0) = 1 | D_i=1)$, yields -->
