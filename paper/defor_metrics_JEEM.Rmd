...
Each of our simulated landscapes consists of administrative units that are either untreated $(D_i=0)$ or are assigned to a conservation treatment $(D_i=1)$. We observe deforestation in two, even-length periods. There exists both a pre-treatment $(t < t_{0})$ and a post-treatment $(t \ge t_{0})$ period, each consisting of multiple years.
