...
This work makes important contributions to several literatures. First, we contribute to the vast literature evaluating the impacts of forest conservation policy with rigorous methods []. 
...
Although this paper focuses upon impact evaluation of forest conservation policies, our findings are relevant to a wider audience. Specifically, these results apply to diverse settings in which the outcome of interest represents an irreversible, binary event. We identify several studies examining events such as mortality, recidivism, and technology adoption that fall prey to the concerns we identify in this paper. 
