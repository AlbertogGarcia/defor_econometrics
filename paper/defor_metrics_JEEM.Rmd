...
text(x=2.5 , y=0.0135, "Survival models", col=palette$blue, font=1)
text(x=5.6 , y=0.0125, "Aggregated\nfixed effects", col=palette$dark, font=1)
text(x=9 , y=0.0125, "Aggregated unit\nof analysis", col=palette$blue, font=1)
...
text(x=mean(1:nrow(select_results))
     , y=topline-.0018, "RMSE", col="black", font=2)
text(x=2.5 , y=0.012, "Survival models", col=palette$dark_blue, font=1)
text(x=5.6 , y=0.011, "Aggregated\nfixed effects", col=palette$dark, font=1)
text(x=9 , y=0.011, "Aggregated unit\nof analysis", col=palette$dark_blue, font=1)
