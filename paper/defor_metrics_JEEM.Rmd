...
Below, we present a simple example of panel data following this guidance. Suppose we observe data on nine pixels with structure similar to @hansen2013 and are interested in deforestation over six years, where treatment of some pixels begins in year 4. Note that panel datasets with this structure still maintain variation across groups, pre and post-treatment. 
