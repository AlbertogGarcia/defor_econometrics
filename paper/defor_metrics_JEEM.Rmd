...
df_summary <- rbind(df_summary[5,], df_summary[7:9,],  df_summary[1:4,],
                    df_summary[6,])
...
schart(select_results,labels, ylim = ylim, index.ci=index.ci, col.est = c(palette$dark, palette$blue),
       ...
       ylab="    Bias", highlight=c(2,3,4,5, 9, 10)
       ,band.ref=c(-.05, .04)
       , axes = FALSE
       #, col.band.ref="#c7e9f9"
...
text(x=9.5 , y=0.0135, "Survival models", col=palette$blue, font=1)
...
text(x=mean(1:nrow(select_results))
     , y=topline-.0018, "RMSE", col="black", font=2)
text(x=3.5 , y=0.011, "Aggregated\nfixed effects", col=palette$dark, font=1)
text(x=6.9 , y=0.011, "Aggregated unit\nof analysis", col=palette$dark_blue, font=1)
text(x=9.5 , y=0.012, "Survival models", col=palette$dark_blue, font=1)
