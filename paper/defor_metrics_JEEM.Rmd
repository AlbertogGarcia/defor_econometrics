...
\end{align}
, where $F_{j,t}$ and $F_{j,t-1}$ are area of forest cover within unit $j$ at times $t$ and $t-1$, respectively. We explore the relative merits and performance of alternative deforestation rate calculations in Section \@ref(rate-formula).
