...
#begin function
multiple_gridsize <- function(n, nobs, years, b0, b1, b2_0, b2_1, std_a = 0.1, std_v = 0.25, std_p = 0.0, std_b3 = 0.0, given_ATT, cellsize_list, ppoints, cpoints, rm.selection = FALSE){
