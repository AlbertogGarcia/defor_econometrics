...
# creating bias csv
biases_c <- data.frame("0" = colMeans(layerbiases_c0) , "0.05" = colMeans(layerbiases_c5), "0.10" = colMeans(layerbiases_c10),"0.15" = colMeans(layerbiases_c15), "0.25" = colMeans(layerbiases_c25) ,check.names = FALSE)
