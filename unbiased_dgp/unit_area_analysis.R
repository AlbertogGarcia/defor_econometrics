...
all_gridsizes <- rbind(summary_grid, summary_grid_pu)#, summary_grid_05)
...
my_breaks = c(25, 100, 225, 400, 625, 900, 1600)
all_grid_plot <- ggplot()+
  ...
  scale_x_continuous(
    breaks = my_breaks,
    labels = c("5x5", "10x10", "15x15", "20x20", "25x25", "30x30", "40x40"),
    #limits = c(0, 20^2),
    name = "Grid size") +
  theme_minimal()+
  theme(text = element_text(size=15),
