...
```{r county_intro, results='hide'}
county <- county_sims(n, nobs, years, b0, b1, b2, b3, std_a, std_v, std_p, 4, ppoints, cpoints)
county$plot
```
...
# ```{r covers, results='hide'}
# county_cover <- clustercover(5, nobs, years, b0, b1, b2, b3, std_a, std_v, std_p, 4, ppoints, cpoints)
# county_cover$plot
# coverages_df <- county_cover$cover_df
# mean(coverages_df$property_cover)
# ```