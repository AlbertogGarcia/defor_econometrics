...
ATT_bias <- xy_ATT(n, nobs, years, min_ATT, max_ATT, base_0, base_1, trend, std_a, std_v, "y_it")

ATT_bias$plot
  
```

```{r xy agg plot ATT, results = 'hide', warning=FALSE}
ATTagg_bias <- xy_agg_ATT(30, nobs, years, min_ATT, max_ATT, base_0, base_1, trend, std_a, std_v, std_p, cellsize, ppoints, cpoints)
...
p_err_bias <- xy_proppert(30, nobs, years, ATT, base_0, base_1, trend, std_a, std_v, min_std_p, max_std_p, interval, cellsize, ppoints, cpoints)
