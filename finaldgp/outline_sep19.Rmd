...
ggsave(path = "figs", filename = "fig1.png", height = 3, width = 6, dpi = 300)
...
```{r DIDy1plot, results='hide', warning = FALSE}
DID_keep$plot

ggsave('figures/fig2.png', height = 3, width = 6, dpi = 300)
...
DID_drop$plot
ggsave('figures/fig3.png', height = 3, width = 6, dpi = 300)
...
```{r landscape maps, results = 'hide', warning=FALSE}
landscape_map <- aggregation_method(nobs, years, b0, b1, b2, b3, std_a, std_v, std_p, cellsize, ppoints, cpoints)

landscape_map$landscape_year4
landscape_map$landscape_counter_year4
...
\begin{tabular}{ |c|c|c| } 
 ...
 county  & classical & `r weighting$county_cover` \\
...
p_err_bias <- xy_proppert(50, nobs, years, ATT, base_0, base_1, trend, std_a, std_v, min_std_p, max_std_p, interval, cellsize, ppoints, cpoints)
