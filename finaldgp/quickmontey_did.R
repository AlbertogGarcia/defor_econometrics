...
#begin function
quickmontey_did <- function(n, nobs, years, b0, b1, b2, b3, std_a = 0.1, std_v = 0.25, outcome_var = "y"){
  ...
  outputs = list("plot" = plot, "did_biases" = did_coeff, "did_mean" = mean(did_coeff$V1), "did_RMSE" = rmse(actual, did_coeff$V1)
                 )
  return(outputs)
